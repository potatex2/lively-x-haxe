...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("PauseWallpaper", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("PauseWallpaper", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "PauseWallpaper";
		app.meta["name"] = "WallpaperState";
		...
		#elseif air
		app.window.title = "WallpaperState";
		#else
		app.window.context.attributes.background = 4473924;
