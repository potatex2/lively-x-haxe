...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__bulkassets_beep_ogg extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__bulkassets_buttons_config_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__bulkassets_buttons_discord_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__bulkassets_buttons_musicicon_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__bulkassets_buttons_psychicon_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__bulkassets_buttons_vscode_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__bulkassets_music_breakfast_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__bulkassets_music_reborn_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__bulkassets_music_reborn_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__bulkassets_music_redux_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__bulkassets_music_redux_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__bulkassets_music_strident_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__bulkassets_music_strident_ogg extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__bulkassets_reload_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__bulkassets_saveconfig_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__bulkassets_settings_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__bulkassets_tabbackin_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__bulkassets_togglejingle_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__bulkassets_vscode_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:font("C:/Users/PotateX2/lime/flixel/5,8,0/assets/fonts/nokiafc22.ttf") @:noCompletion #if display private #end class __ASSET__flixel_fonts_nokiafc22_ttf extends lime.text.Font {}
@:keep @:font("C:/Users/PotateX2/lime/flixel/5,8,0/assets/fonts/monsterrat.ttf") @:noCompletion #if display private #end class __ASSET__flixel_fonts_monsterrat_ttf extends lime.text.Font {}
...
@:keep @:noCompletion #if display private #end class __ASSET__bulkassets_phantommuff_ttf extends lime.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "bulkAssets/PhantomMuff.ttf"; name = "PhantomMuff 1.5"; super (); }}


#else

@:keep @:expose('__ASSET__bulkassets_phantommuff_ttf') @:noCompletion #if display private #end class __ASSET__bulkassets_phantommuff_ttf extends lime.text.Font { public function new () { #if !html5 __fontPath = "bulkAssets/PhantomMuff.ttf"; #else ascender = null; descender = null; height = null; numGlyphs = null; underlinePosition = null; underlineThickness = null; unitsPerEM = null; #end name = "PhantomMuff 1.5"; super (); }}
...
#if html5
@:keep @:expose('__ASSET__OPENFL__bulkassets_phantommuff_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__bulkassets_phantommuff_ttf extends openfl.text.Font { public function new () { name = "PhantomMuff 1.5"; super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_nokiafc22_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_nokiafc22_ttf ()); super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_monsterrat_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_monsterrat_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_monsterrat_ttf ()); super (); }}

#else
@:keep @:expose('__ASSET__OPENFL__bulkassets_phantommuff_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__bulkassets_phantommuff_ttf extends openfl.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "bulkAssets/PhantomMuff.ttf"; name = "PhantomMuff 1.5"; super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_nokiafc22_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_nokiafc22_ttf ()); super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_monsterrat_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_monsterrat_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_monsterrat_ttf ()); super (); }}
