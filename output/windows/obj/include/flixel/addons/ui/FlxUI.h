...
class HXCPP_CLASS_ATTRIBUTES FlxUI_obj : public  ::flixel::addons::ui::FlxTypedUIGroup_obj
{
	public:
	...
	public:
		...
		::Dynamic showThing_dyn();
		 ...
		 ::flixel::addons::ui::FlxTypedUIGroup getGroup(::String key,::hx::Null< bool >  recursive);
		...
		::Dynamic getAssetsWithTag_dyn();
		 ...
		 ::flixel::addons::ui::FlxTypedUIGroup getAssetGroup(::String key,::Dynamic thing);
		...
		::Dynamic _loadHeight_dyn();
		 ...
		 ::flixel::math::FlxBasePoint _loadCompass( ::Xml data,::String str);
		...
		void _doAlign(::Array< ::String > objects,::String axis,Float spacing,bool resize, ::flixel::math::FlxBasePoint bounds,::hx::Null< bool >  allowGrow,::hx::Null< bool >  allowShrink);
		...
		::Dynamic _loadNumericStepper_dyn();
		 ...
		 ::flixel::math::FlxBasePoint getResizeRatio( ::Xml data,::hx::Null< int >  defaultAxis);
