...
class HXCPP_CLASS_ATTRIBUTES FlxUIList_obj : public  ::flixel::addons::ui::FlxTypedUIGroup_obj
{
	public:
	...
	public:
		...
		void __construct(::hx::Null< Float >  __o_X,::hx::Null< Float >  __o_Y,::Array< ::Dynamic> Widgets,::hx::Null< Float >  __o_W,::hx::Null< Float >  __o_H,::String __o_MoreString, ::Dynamic __o_Stacking, ::Dynamic __o_Spacing, ::flixel::math::FlxBasePoint PrevButtonOffset, ::flixel::math::FlxBasePoint NextButtonOffset,::Dynamic PrevButton,::Dynamic NextButton);
		...
		::Dynamic set_spacing_dyn();
		 ...
		 ::flixel::math::FlxBasePoint prevButtonOffset;
		 ::flixel::math::FlxBasePoint nextButtonOffset;
		::Dynamic prevButton;
		::Dynamic nextButton;
		::String moreString;
