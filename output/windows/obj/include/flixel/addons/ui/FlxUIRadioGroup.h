...
class HXCPP_CLASS_ATTRIBUTES FlxUIRadioGroup_obj : public  ::flixel::addons::ui::FlxTypedUIGroup_obj
{
	public:
	...
	public:
		...
		::Dynamic set_selectedId_dyn();
		 ...
		 ::flixel::math::FlxBasePoint setLineScroll(int scroll, ::Dynamic max_items);
