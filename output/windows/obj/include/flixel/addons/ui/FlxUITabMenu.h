...
class HXCPP_CLASS_ATTRIBUTES FlxUITabMenu_obj : public  ::flixel::addons::ui::FlxTypedUIGroup_obj
{
	public:
		typedef  ::flixel::addons::ui::FlxTypedUIGroup_obj super;
	...
	public:
		...
		void __construct( ::flixel::FlxSprite back_,::Array< ::Dynamic> tabs_,::Array< ::Dynamic> tab_names_and_labels_, ::flixel::math::FlxBasePoint tab_offset, ::Dynamic __o_stretch_tabs, ::Dynamic tab_spacing,::Array< ::String > tab_stacking);
		...
		static ::hx::ObjectPtr< FlxUITabMenu_obj > __new( ::flixel::FlxSprite back_,::Array< ::Dynamic> tabs_,::Array< ::Dynamic> tab_names_and_labels_, ::flixel::math::FlxBasePoint tab_offset, ::Dynamic __o_stretch_tabs, ::Dynamic tab_spacing,::Array< ::String > tab_stacking);
		static ::hx::ObjectPtr< FlxUITabMenu_obj > __alloc(::hx::Ctx *_hx_ctx, ::flixel::FlxSprite back_,::Array< ::Dynamic> tabs_,::Array< ::Dynamic> tab_names_and_labels_, ::flixel::math::FlxBasePoint tab_offset, ::Dynamic __o_stretch_tabs, ::Dynamic tab_spacing,::Array< ::String > tab_stacking);
		...
		::Dynamic getTab_dyn();
		 ...
		 ::flixel::addons::ui::FlxTypedUIGroup getTabGroup(::String name, ::Dynamic index);
		...
		void addGroup( ::flixel::addons::ui::FlxTypedUIGroup g);
		...
		::Array< ::String > _tab_stacking;
		 ::flixel::math::FlxBasePoint _tab_offset;
