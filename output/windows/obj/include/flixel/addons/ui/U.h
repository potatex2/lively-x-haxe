...
class HXCPP_CLASS_ATTRIBUTES U_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::flixel::math::FlxBasePoint xml_pt( ::Xml data,::String att, ::flixel::math::FlxBasePoint default_);
		static ::Dynamic xml_pt_dyn();

		static bool boolify(::String str);
		static ::Dynamic boolify_dyn();

		static  ::flixel::math::FlxBasePoint pointify(::String str);
		...
		static  ::flixel::math::FlxBasePoint applyResize(Float resize_ratio,int resize_ratio_axis,Float w,Float h, ::flixel::math::FlxBasePoint pt);
		...
		static  ::flixel::math::FlxBasePoint obj_direction( ::flixel::FlxObject a, ::flixel::FlxObject b);
