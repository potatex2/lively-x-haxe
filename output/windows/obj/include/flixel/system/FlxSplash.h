...
class HXCPP_CLASS_ATTRIBUTES FlxSplash_obj : public  ::flixel::FlxState_obj
{
	...
	public:
		...
		static bool muted;
		static bool WIP;
		static ::String contextOverride;
		static void creditOverride( ::flixel::_hx_system::Context ctx);
		static ::Dynamic creditOverride_dyn();

		 ::flixel::FlxSprite sprite;
		 ::openfl::display::Sprite _sprite;
		 ::openfl::display::Graphics _gfx;
		 ::openfl::text::TextField _text;
		 ::openfl::text::TextField _credit;
		 ::flixel::text::FlxText _WIP;
		 ::flixel::util::FlxTimer init;
		::Array< Float > _times;
		::Array< int > _colors;
