...
HX_DEFINE_STACK_FRAME(_hx_pos_0beb5da3a19aed74_292_new,"__ASSET__flixel_flixel_ui_img_check_mark_png","new",0xfe81e957,"__ASSET__flixel_flixel_ui_img_check_mark_png.new","lime/_internal/macros/AssetsMacro.hx",292,0xc651f030)
HX_LOCAL_STACK_FRAME(_hx_pos_0beb5da3a19aed74_146_boot,"__ASSET__flixel_flixel_ui_img_check_mark_png","boot",0xab43435b,"__ASSET__flixel_flixel_ui_img_check_mark_png.boot","lime/_internal/macros/AssetsMacro.hx",146,0xc651f030)
...
void __ASSET__flixel_flixel_ui_img_check_mark_png_obj::__construct( ::lime::graphics::ImageBuffer buffer, ::Dynamic offsetX, ::Dynamic offsetY, ::Dynamic width, ::Dynamic height, ::Dynamic color, ::lime::graphics::ImageType type){
            	HX_STACKFRAME(&_hx_pos_0beb5da3a19aed74_292_new)
HXLINE( 293)		super::__construct(null(),null(),null(),null(),null(),null(),null());
HXLINE( 295)		this->_hx___fromBytes(::haxe::Resource_obj::getBytes(HX_("__ASSET__:image___ASSET__flixel_flixel_ui_img_check_mark_png",73,3f,b4,e4)),null());
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_0beb5da3a19aed74_146_boot)
HXDLIN( 146)		resourceName = HX_("__ASSET__:image___ASSET__flixel_flixel_ui_img_check_mark_png",73,3f,b4,e4);
            	}
}
