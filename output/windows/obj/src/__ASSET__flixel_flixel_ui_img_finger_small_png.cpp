...
HX_DEFINE_STACK_FRAME(_hx_pos_a8b28c08cd7936ec_292_new,"__ASSET__flixel_flixel_ui_img_finger_small_png","new",0x4e817064,"__ASSET__flixel_flixel_ui_img_finger_small_png.new","lime/_internal/macros/AssetsMacro.hx",292,0xc651f030)
HX_LOCAL_STACK_FRAME(_hx_pos_a8b28c08cd7936ec_146_boot,"__ASSET__flixel_flixel_ui_img_finger_small_png","boot",0x5ad9e7ae,"__ASSET__flixel_flixel_ui_img_finger_small_png.boot","lime/_internal/macros/AssetsMacro.hx",146,0xc651f030)
...
void __ASSET__flixel_flixel_ui_img_finger_small_png_obj::__construct( ::lime::graphics::ImageBuffer buffer, ::Dynamic offsetX, ::Dynamic offsetY, ::Dynamic width, ::Dynamic height, ::Dynamic color, ::lime::graphics::ImageType type){
            	HX_STACKFRAME(&_hx_pos_a8b28c08cd7936ec_292_new)
HXLINE( 293)		super::__construct(null(),null(),null(),null(),null(),null(),null());
HXLINE( 295)		this->_hx___fromBytes(::haxe::Resource_obj::getBytes(HX_("__ASSET__:image___ASSET__flixel_flixel_ui_img_finger_small_png",80,fb,be,f7)),null());
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_a8b28c08cd7936ec_146_boot)
HXDLIN( 146)		resourceName = HX_("__ASSET__:image___ASSET__flixel_flixel_ui_img_finger_small_png",80,fb,be,f7);
            	}
}
