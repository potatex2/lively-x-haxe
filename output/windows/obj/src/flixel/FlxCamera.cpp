...
HXLINE( 935)			{
HXLINE( 935)				 ::flixel::math::FlxRect _this3 = this->_bounds;
HXDLIN( 935)				_this3->x = ( (Float)(0) );
HXDLIN( 935)				_this3->y = ( (Float)(0) );
HXDLIN( 935)				_this3->width = ( (Float)(this->width) );
HXDLIN( 935)				_this3->height = ( (Float)(this->height) );
            			}
