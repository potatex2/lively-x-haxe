...
HXLINE( 637)		 ::flixel::_hx_system::frontEnds::InputFrontEnd _hx_tmp = ::flixel::FlxG_obj::inputs;
HXDLIN( 637)		::flixel::FlxG_obj::set_mouse(_hx_tmp->add_flixel_input_mouse_FlxMouse( ::flixel::input::mouse::FlxMouse_obj::__alloc( HX_CTX ,game->_inputContainer)));
HXLINE( 641)		 ::flixel::_hx_system::frontEnds::InputFrontEnd _hx_tmp1 = ::flixel::FlxG_obj::inputs;
HXDLIN( 641)		::flixel::FlxG_obj::touches = _hx_tmp1->add_flixel_input_touch_FlxTouchManager( ::flixel::input::touch::FlxTouchManager_obj::__alloc( HX_CTX ));
