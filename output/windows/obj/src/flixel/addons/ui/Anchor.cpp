...
HXLINE(  41)			Float destination2 = destination->x;
HXDLIN(  41)			destX = (destination2 + destination->get_width());
...
HXLINE(  48)			Float destination3 = destination->y;
HXDLIN(  48)			destY = (destination3 + destination->get_height());
HXDLIN(  48)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_1==HX_("center",d5,25,db,05)) ){
HXLINE(  49)			Float destination4 = destination->y;
HXDLIN(  49)			destY = (destination4 + (destination->get_height() / ( (Float)(2) )));
