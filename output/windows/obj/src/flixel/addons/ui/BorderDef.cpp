...
HXLINE(  64)					_hx_tmp3 = (border_str != HX_("false",a3,35,4f,fb));
            				}
            				else {
HXLINE(  64)					_hx_tmp3 = false;
            				}
HXDLIN(  64)				if (_hx_tmp3) {
HXLINE(  64)					_hx_tmp2 = (border_str != HX_("none",b8,12,0a,49));
            				}
            				else {
...
HXLINE(  67)					 ::Dynamic return_val1 = ::flixel::util::_FlxColor::FlxColor_Impl__obj::fromString(border_str);
HXDLIN(  67)					if (::hx::IsNull( return_val1 )) {
HXLINE(  67)						return_val1 = 0;
            					}
HXDLIN(  67)					borderDef->color = ( (int)(return_val1) );
            				}
            				else {
...
HXLINE(  72)						_hx_tmp5 = (border_str != HX_("false",a3,35,4f,fb));
            					}
            					else {
HXLINE(  72)						_hx_tmp5 = false;
            					}
HXDLIN(  72)					if (_hx_tmp5) {
HXLINE(  72)						_hx_tmp4 = (border_str != HX_("none",b8,12,0a,49));
            					}
            					else {
...
HXLINE(  75)						 ::Dynamic return_val2 = ::flixel::util::_FlxColor::FlxColor_Impl__obj::fromString(border_str);
HXDLIN(  75)						if (::hx::IsNull( return_val2 )) {
HXLINE(  75)							return_val2 = 0;
            						}
HXDLIN(  75)						borderDef->color = ( (int)(return_val2) );
            					}
            				}
            			}
