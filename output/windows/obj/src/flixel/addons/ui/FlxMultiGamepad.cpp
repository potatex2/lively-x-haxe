...
HX_LOCAL_STACK_FRAME(_hx_pos_8bad450b97371a8c_31_checkJustPressed,"flixel.addons.ui.FlxMultiGamepad","checkJustPressed",0xe0a01f73,"flixel.addons.ui.FlxMultiGamepad.checkJustPressed","flixel/addons/ui/FlxMultiGamepad.hx",31,0xf1b907f6)
HX_LOCAL_STACK_FRAME(_hx_pos_8bad450b97371a8c_36_checkJustReleased,"flixel.addons.ui.FlxMultiGamepad","checkJustReleased",0xb25172cc,"flixel.addons.ui.FlxMultiGamepad.checkJustReleased","flixel/addons/ui/FlxMultiGamepad.hx",36,0xf1b907f6)
...
HX_LOCAL_STACK_FRAME(_hx_pos_8bad450b97371a8c_46_checkCombos,"flixel.addons.ui.FlxMultiGamepad","checkCombos",0x7ea06fe8,"flixel.addons.ui.FlxMultiGamepad.checkCombos","flixel/addons/ui/FlxMultiGamepad.hx",46,0xf1b907f6)
HX_LOCAL_STACK_FRAME(_hx_pos_8bad450b97371a8c_51_checkForbiddens,"flixel.addons.ui.FlxMultiGamepad","checkForbiddens",0xf615a25d,"flixel.addons.ui.FlxMultiGamepad.checkForbiddens","flixel/addons/ui/FlxMultiGamepad.hx",51,0xf1b907f6)
namespace flixel{
namespace addons{
namespace ui{
...
bool FlxMultiGamepad_obj::checkJustPressed(){
            	HX_STACKFRAME(&_hx_pos_8bad450b97371a8c_31_checkJustPressed)
HXDLIN(  31)		 ::flixel::input::gamepad::FlxGamepad _this = this->gamepad;
HXDLIN(  31)		int ID = this->input;
HXDLIN(  31)		int Status = 2;
HXDLIN(  31)		switch((int)(ID)){
            			case (int)-2: {
HXDLIN(  31)				return _this->anyButton(Status);
            			}
            			break;
            			case (int)-1: {
HXDLIN(  31)				return !(_this->anyButton(Status));
...
HXDLIN(  31)				if (::hx::IsNotNull( button )) {
HXDLIN(  31)					return button->hasState(Status);
            				}
            				else {
...
bool FlxMultiGamepad_obj::checkJustReleased(){
            	HX_STACKFRAME(&_hx_pos_8bad450b97371a8c_36_checkJustReleased)
HXDLIN(  36)		 ::flixel::input::gamepad::FlxGamepad _this = this->gamepad;
HXDLIN(  36)		int ID = this->input;
HXDLIN(  36)		int Status = -1;
HXDLIN(  36)		switch((int)(ID)){
            			case (int)-2: {
HXDLIN(  36)				return _this->anyButton(Status);
            			}
            			break;
            			case (int)-1: {
HXDLIN(  36)				return !(_this->anyButton(Status));
...
HXDLIN(  36)				if (::hx::IsNotNull( button )) {
HXDLIN(  36)					return button->hasState(Status);
            				}
            				else {
...
HXDLIN(  41)		int ID = this->input;
HXDLIN(  41)		int Status = 1;
HXDLIN(  41)		switch((int)(ID)){
            			case (int)-2: {
HXDLIN(  41)				return _this->anyButton(Status);
            			}
            			break;
            			case (int)-1: {
HXDLIN(  41)				return !(_this->anyButton(Status));
...
HXDLIN(  41)				if (::hx::IsNotNull( button )) {
HXDLIN(  41)					return button->hasState(Status);
            				}
            				else {
...
bool FlxMultiGamepad_obj::checkCombos(bool value){
            	HX_STACKFRAME(&_hx_pos_8bad450b97371a8c_46_checkCombos)
HXDLIN(  46)		return (this->gamepad->checkButtonArrayState(this->combos,1) == value);
            	}


bool FlxMultiGamepad_obj::checkForbiddens(bool value){
            	HX_STACKFRAME(&_hx_pos_8bad450b97371a8c_51_checkForbiddens)
HXDLIN(  51)		return (this->gamepad->checkButtonArrayState(this->forbiddens,1) == value);
            	}
