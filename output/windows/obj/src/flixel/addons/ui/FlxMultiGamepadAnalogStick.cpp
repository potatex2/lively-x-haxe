...
HXLINE(  69)							 ::flixel::input::gamepad::FlxGamepad _this1 = this->gamepad->analog->value->gamepad;
HXDLIN(  69)							return (_this1->getAnalogXAxisValue(_this1->mapping->getAnalogStick(19)) > dz);
            						}
            						else {
HXLINE(  69)							 ::flixel::input::gamepad::FlxGamepad _this2 = this->gamepad->analog->value->gamepad;
HXDLIN(  69)							return (_this2->getAnalogXAxisValue(_this2->mapping->getAnalogStick(19)) < -(dz));
            						}
            					}
            					else {
...
HXLINE(  78)					 ::flixel::input::gamepad::lists::FlxGamepadAnalogStateList _this3 = this->gamepad->analog->justMoved;
HXDLIN(  78)					 ::flixel::input::gamepad::FlxGamepadAnalogStick stick1 = _this3->gamepad->mapping->getAnalogStick(19);
HXDLIN(  78)					bool _hx_tmp1;
HXDLIN(  78)					if (::hx::IsNull( stick1 )) {
HXLINE(  78)						_hx_tmp1 = false;
            					}
            					else {
HXLINE(  78)						 ::flixel::input::gamepad::FlxGamepadButton button1 = _this3->gamepad->buttons->__get(stick1->y).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN(  78)						if (::hx::IsNotNull( button1 )) {
HXLINE(  78)							_hx_tmp1 = button1->hasState(_this3->status);
            						}
            						else {
HXLINE(  78)							_hx_tmp1 = false;
            						}
...
HXLINE(  80)							 ::flixel::input::gamepad::FlxGamepad _this4 = this->gamepad->analog->value->gamepad;
HXDLIN(  80)							return (_this4->getYAxisRaw(_this4->mapping->getAnalogStick(19)) > dz);
            						}
            						else {
HXLINE(  80)							 ::flixel::input::gamepad::FlxGamepad _this5 = this->gamepad->analog->value->gamepad;
HXDLIN(  80)							return (_this5->getYAxisRaw(_this5->mapping->getAnalogStick(19)) < -(dz));
            						}
            					}
            					else {
...
HXLINE(  90)					 ::flixel::input::gamepad::lists::FlxGamepadAnalogStateList _this6 = this->gamepad->analog->justMoved;
HXDLIN(  90)					 ::flixel::input::gamepad::FlxGamepadAnalogStick stick2 = _this6->gamepad->mapping->getAnalogStick(20);
HXDLIN(  90)					bool _hx_tmp2;
HXDLIN(  90)					if (::hx::IsNull( stick2 )) {
HXLINE(  90)						_hx_tmp2 = false;
            					}
            					else {
HXLINE(  90)						 ::flixel::input::gamepad::FlxGamepadButton button2 = _this6->gamepad->buttons->__get(stick2->x).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN(  90)						if (::hx::IsNotNull( button2 )) {
HXLINE(  90)							_hx_tmp2 = button2->hasState(_this6->status);
            						}
            						else {
HXLINE(  90)							_hx_tmp2 = false;
            						}
...
HXLINE(  92)							 ::flixel::input::gamepad::FlxGamepad _this7 = this->gamepad->analog->value->gamepad;
HXDLIN(  92)							return (_this7->getAnalogXAxisValue(_this7->mapping->getAnalogStick(20)) > dz);
            						}
            						else {
HXLINE(  92)							 ::flixel::input::gamepad::FlxGamepad _this8 = this->gamepad->analog->value->gamepad;
HXDLIN(  92)							return (_this8->getAnalogXAxisValue(_this8->mapping->getAnalogStick(20)) < -(dz));
            						}
            					}
            					else {
...
HXLINE( 101)					 ::flixel::input::gamepad::lists::FlxGamepadAnalogStateList _this9 = this->gamepad->analog->justMoved;
HXDLIN( 101)					 ::flixel::input::gamepad::FlxGamepadAnalogStick stick3 = _this9->gamepad->mapping->getAnalogStick(20);
HXDLIN( 101)					bool _hx_tmp3;
HXDLIN( 101)					if (::hx::IsNull( stick3 )) {
HXLINE( 101)						_hx_tmp3 = false;
            					}
            					else {
HXLINE( 101)						 ::flixel::input::gamepad::FlxGamepadButton button3 = _this9->gamepad->buttons->__get(stick3->y).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 101)						if (::hx::IsNotNull( button3 )) {
HXLINE( 101)							_hx_tmp3 = button3->hasState(_this9->status);
            						}
            						else {
HXLINE( 101)							_hx_tmp3 = false;
            						}
...
HXLINE( 103)							 ::flixel::input::gamepad::FlxGamepad _this10 = this->gamepad->analog->value->gamepad;
HXDLIN( 103)							return (_this10->getYAxisRaw(_this10->mapping->getAnalogStick(20)) > dz);
            						}
            						else {
HXLINE( 103)							 ::flixel::input::gamepad::FlxGamepad _this11 = this->gamepad->analog->value->gamepad;
HXDLIN( 103)							return (_this11->getYAxisRaw(_this11->mapping->getAnalogStick(20)) < -(dz));
            						}
            					}
            					else {
...
HXLINE( 123)					 ::flixel::input::gamepad::lists::FlxGamepadAnalogStateList _this2 = this->gamepad->analog->justReleased;
HXDLIN( 123)					 ::flixel::input::gamepad::FlxGamepadAnalogStick stick2 = _this2->gamepad->mapping->getAnalogStick(20);
HXDLIN( 123)					if (::hx::IsNull( stick2 )) {
HXLINE( 123)						return false;
            					}
            					else {
HXLINE( 123)						 ::flixel::input::gamepad::FlxGamepadButton button2 = _this2->gamepad->buttons->__get(stick2->x).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 123)						if (::hx::IsNotNull( button2 )) {
HXLINE( 123)							return button2->hasState(_this2->status);
            						}
            						else {
HXLINE( 123)							return false;
            						}
...
HXLINE( 123)					 ::flixel::input::gamepad::lists::FlxGamepadAnalogStateList _this3 = this->gamepad->analog->justReleased;
HXDLIN( 123)					 ::flixel::input::gamepad::FlxGamepadAnalogStick stick3 = _this3->gamepad->mapping->getAnalogStick(20);
HXDLIN( 123)					if (::hx::IsNull( stick3 )) {
HXLINE( 123)						return false;
            					}
            					else {
HXLINE( 123)						 ::flixel::input::gamepad::FlxGamepadButton button3 = _this3->gamepad->buttons->__get(stick3->y).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 123)						if (::hx::IsNotNull( button3 )) {
HXLINE( 123)							return button3->hasState(_this3->status);
            						}
            						else {
HXLINE( 123)							return false;
            						}
...
HXLINE( 139)						 ::flixel::input::gamepad::FlxGamepad _this1 = this->gamepad->analog->value->gamepad;
HXDLIN( 139)						return (_this1->getAnalogXAxisValue(_this1->mapping->getAnalogStick(19)) < -(dz));
            					}
            				}
            				else {
HXLINE( 143)					if (( (bool)(this->sInput->__Field(HX_("positive",b9,a6,fa,ca),::hx::paccDynamic)) )) {
HXLINE( 143)						 ::flixel::input::gamepad::FlxGamepad _this2 = this->gamepad->analog->value->gamepad;
HXDLIN( 143)						return (_this2->getYAxisRaw(_this2->mapping->getAnalogStick(19)) > dz);
            					}
            					else {
HXLINE( 143)						 ::flixel::input::gamepad::FlxGamepad _this3 = this->gamepad->analog->value->gamepad;
HXDLIN( 143)						return (_this3->getYAxisRaw(_this3->mapping->getAnalogStick(19)) < -(dz));
            					}
            				}
            			}
            			break;
...
HXLINE( 148)						 ::flixel::input::gamepad::FlxGamepad _this4 = this->gamepad->analog->value->gamepad;
HXDLIN( 148)						return (_this4->getAnalogXAxisValue(_this4->mapping->getAnalogStick(20)) > dz);
            					}
            					else {
HXLINE( 148)						 ::flixel::input::gamepad::FlxGamepad _this5 = this->gamepad->analog->value->gamepad;
HXDLIN( 148)						return (_this5->getAnalogXAxisValue(_this5->mapping->getAnalogStick(20)) < -(dz));
            					}
            				}
            				else {
HXLINE( 152)					if (( (bool)(this->sInput->__Field(HX_("positive",b9,a6,fa,ca),::hx::paccDynamic)) )) {
HXLINE( 152)						 ::flixel::input::gamepad::FlxGamepad _this6 = this->gamepad->analog->value->gamepad;
HXDLIN( 152)						return (_this6->getYAxisRaw(_this6->mapping->getAnalogStick(20)) > dz);
            					}
            					else {
HXLINE( 152)						 ::flixel::input::gamepad::FlxGamepad _this7 = this->gamepad->analog->value->gamepad;
HXDLIN( 152)						return (_this7->getYAxisRaw(_this7->mapping->getAnalogStick(20)) < -(dz));
            					}
            				}
            			}
            			break;
