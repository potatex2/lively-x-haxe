...
HXLINE(  80)				Float _hx_tmp1 = this->get_width();
HXDLIN(  80)				this->doResize(_hx_tmp1,this->get_height(),false);
            			}
            			else {
HXLINE(  87)				Float _hx_tmp2 = this->get_width();
HXDLIN(  87)				this->doResize(_hx_tmp2,this->get_height(),true);
            			}
            		}
            	}
...
HXLINE( 213)		{
HXLINE( 213)			int _g = 0;
HXDLIN( 213)			int _g1 = this->get_numFrames();
HXDLIN( 213)			while((_g < _g1)){
HXLINE( 213)				_g = (_g + 1);
HXDLIN( 213)				int i = (_g - 1);
HXLINE( 216)				int _hx_tmp1;
HXDLIN( 216)				if ((i > 2)) {
HXLINE( 216)					_hx_tmp1 = 2;
            				}
            				else {
HXLINE( 216)					_hx_tmp1 = i;
            				}
HXLINE( 215)				int _hx_tmp2 = (sx + ::Std_obj::_hx_int(this->labelOffsets->__get(_hx_tmp1).StaticCast<  ::flixel::math::FlxBasePoint >()->x));
HXLINE( 216)				int _hx_tmp3 = (sy + ::Std_obj::_hx_int((( (Float)(i) ) * this->get_height())));
HXLINE( 218)				int _hx_tmp4;
HXDLIN( 218)				if ((i > 2)) {
HXLINE( 218)					_hx_tmp4 = 2;
            				}
            				else {
HXLINE( 218)					_hx_tmp4 = i;
            				}
HXLINE( 215)				this->stamp(icon,_hx_tmp2,(_hx_tmp3 + ::Std_obj::_hx_int(this->labelOffsets->__get(_hx_tmp4).StaticCast<  ::flixel::math::FlxBasePoint >()->y)));
            			}
            		}
            	}
...
HXLINE( 286)					_hx_tmp1 = ::hx::IsNotNull( this->down_style );
            				}
            				else {
...
HXLINE( 316)					_hx_tmp1 = ::hx::IsNotNull( this->over_style );
            				}
            				else {
...
HXLINE( 346)					_hx_tmp1 = ::hx::IsNotNull( this->up_style );
            				}
            				else {
...
HXLINE( 376)					_hx_tmp1 = ::hx::IsNotNull( this->up_style );
            				}
            				else {
