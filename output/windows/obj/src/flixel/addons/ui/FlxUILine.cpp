...
HXLINE(  52)			 ::flixel::math::FlxBasePoint this1 = this->scale;
HXDLIN(  52)			Float y = (((Float)0.5) * this->thickness);
HXDLIN(  52)			this1->set_x((((Float)0.5) * this->length));
HXDLIN(  52)			this1->set_y(y);
            		}
            		else {
HXLINE(  56)			 ::flixel::math::FlxBasePoint this2 = this->scale;
HXDLIN(  56)			Float y1 = (((Float)0.5) * this->length);
HXDLIN(  56)			this2->set_x((((Float)0.5) * this->thickness));
HXDLIN(  56)			this2->set_y(y1);
            		}
