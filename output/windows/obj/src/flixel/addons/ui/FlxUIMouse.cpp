...
HXLINE(  29)		int oldScreenX = this->_globalScreenX;
HXLINE(  30)		int oldScreenY = this->_globalScreenY;
HXLINE(  36)		this->super::update();
HXLINE(  38)		if (!(this->updateGlobalScreenPosition)) {
HXLINE(  41)			this->_globalScreenX = oldScreenX;
HXLINE(  42)			this->_globalScreenY = oldScreenY;
HXLINE(  47)			this->updatePositions();
            		}
            	}
