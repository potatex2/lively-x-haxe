...
HXLINE( 111)				 ::flixel::text::FlxText _hx_tmp1 = this->text_field;
HXDLIN( 111)				Float tens1 = ::Math_obj::pow(( (Float)(10) ),( (Float)(this->decimals) ));
HXDLIN( 111)				_hx_tmp1->set_text(::Std_obj::string((( (Float)(::Math_obj::round((displayValue * tens1))) ) / tens1)));
            			}
            		}
...
HXLINE( 158)				 ::flixel::addons::ui::FlxUITypedButton _hx_tmp7 = this->button_plus;
HXDLIN( 158)				Float _hx_tmp8 = (offsetX + this->text_field->x);
HXDLIN( 158)				_hx_tmp7->set_x((_hx_tmp8 + this->text_field->get_width()));
HXLINE( 159)				this->button_plus->set_y((-(offsetY) + this->text_field->y));
HXLINE( 160)				 ::flixel::addons::ui::FlxUITypedButton _hx_tmp9 = this->button_minus;
HXDLIN( 160)				Float _hx_tmp10 = this->button_plus->x;
HXDLIN( 160)				_hx_tmp9->set_x((_hx_tmp10 + this->button_plus->get_width()));
