...
bool FlxUIRadioGroup_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x41492aa3) {
		if (inClassId<=(int)0x296a9148) {
			...
			return inClassId==(int)0x2c01639b || inClassId==(int)0x41492aa3;
		}
	} else {
...
HXLINE( 171)			 ::flixel::FlxSprite fs1 = ( ( ::flixel::FlxSprite)(this->_dot_asset) );
HXLINE( 172)			this->_dot_asset = fs1->graphic->key;
            		}
HXLINE( 175)		{
HXLINE( 175)			int _g = 0;
...
HXLINE( 464)						_g2->_onCheckBoxEvent(checkBox);
            					}
...
HXLINE( 464)					 ::flixel::addons::ui::FlxUIRadioGroup _g2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 464)					 ::flixel::addons::ui::FlxUICheckBox checkBox = c;
HXDLIN( 464)					c->callback =  ::Dynamic(new _hx_Closure_0(checkBox,_g2));
...
HXLINE( 537)						_hx_tmp1 = ::hx::IsNotNull( this->activeStyle );
            					}
            					else {
