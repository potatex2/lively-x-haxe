...
HX_DEFINE_DYNAMIC_FUNC1(FlxUISprite_obj,set_resize_ratio,return )
 ...
 ::flixel::math::FlxBasePoint FlxUISprite_obj::set_resize_point( ::flixel::math::FlxBasePoint r){
            	HX_STACKFRAME(&_hx_pos_22e81ddbc10a4d63_47_set_resize_point)
HXLINE(  48)		if (::hx::IsNotNull( r )) {
HXLINE(  50)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE(  92)				_hx_tmp1 = ::hx::IsNotNull( newKey );
            			}
            			else {
...
::hx::Val FlxUISprite_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"resize_point") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_resize_point(inValue.Cast<  ::flixel::math::FlxBasePoint >()) );resize_point=inValue.Cast<  ::flixel::math::FlxBasePoint >(); return inValue; }
...
static ::hx::StorageInfo FlxUISprite_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::flixel::math::FlxBasePoint */ ,(int)offsetof(FlxUISprite_obj,resize_point),HX_("resize_point",85,44,f0,71)},
