...
HXLINE(  65)						 ::flixel::FlxSprite sprite1 = _g3->__get(_g2).StaticCast<  ::flixel::FlxSprite >();
HXDLIN(  65)						_g2 = (_g2 + 1);
HXLINE(  67)						sprite1->set_x(((W - sprite1->get_width()) / ( (Float)(2) )));
HXLINE(  68)						sprite1->set_y(((H - sprite1->get_height()) / ( (Float)(2) )));
            					}
            				}
            			}
