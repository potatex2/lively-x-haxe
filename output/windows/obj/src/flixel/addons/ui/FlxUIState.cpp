...
HXLINE( 156)							::String msg1 = ( (::String)(_g->value) );
HXLINE( 158)							errorMsg = msg1;
            						}
            						else {
...
HXLINE( 164)						data = ( ( ::Xml)(::flixel::addons::ui::U_obj::xml(this->_xml_id,HX_("xml",d7,6d,5b,00),true,HX_("",00,00,00,00))) );
            						...
            						if (_hx_e.IsClass< ::String >() && _hx_e->toString()!=null() ){
            							HX_STACK_BEGIN_CATCH
            							::String msg21 = _hx_e;
HXLINE( 168)							errorMsg = (errorMsg + (HX_(", ",74,26,00,00) + msg21));
            						}
            						else if (_hx_e.IsClass<  ::haxe::ValueException >() ){
            							HX_STACK_BEGIN_CATCH
...
HXLINE( 162)							if (::Std_obj::isOfType(_g1->value,::hx::ClassOf< ::String >())) {
HXLINE( 166)								::String msg21 = ( (::String)(_g1->value) );
HXLINE( 168)								errorMsg = (errorMsg + (HX_(", ",74,26,00,00) + msg21));
            							}
            							else {
HXLINE( 162)								HX_STACK_DO_THROW(_g1);
            							}
            						}
            						else {
            							HX_STACK_DO_THROW(_hx_e);
...
HXLINE( 181)					::flixel::FlxG_obj::log->advanced(((HX_("FlxUISubState: Could not load _xml_id \"",93,ad,c0,63) + this->_xml_id) + HX_("\"",22,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            				}
            			}
            			else {
