...
HXDLIN( 210)			::Array< ::Dynamic> _g2 = this->_tabs;
...
HXLINE( 214)					_g3->_onTabEvent(name);
            				}
            				HX_END_LOCAL_FUNC0((void))

HXLINE( 210)				::Dynamic t = _g2->__get(_g1);
HXDLIN( 210)				_g1 = (_g1 + 1);
HXLINE( 212)				tab = ( ( ::flixel::addons::ui::FlxUITypedButton)(t) );
HXLINE( 213)				this->add(tab);
HXLINE( 214)				 ::flixel::addons::ui::FlxUITabMenu _g3 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 214)				::String name = tab->name;
HXDLIN( 214)				 ::Dynamic _hx_tmp =  ::Dynamic(new _hx_Closure_0(name,_g3));
...
HXLINE(  62)				 ::flixel::addons::ui::FlxTypedUIGroup group = _g3->__get(_g2).StaticCast<  ::flixel::addons::ui::FlxTypedUIGroup >();
HXDLIN(  62)				_g2 = (_g2 + 1);
HXLINE(  64)				{
HXLINE(  64)					int _g4 = 0;
HXDLIN(  64)					::Array< ::Dynamic> _g5 = group->group->members;
HXDLIN(  64)					while((_g4 < _g5->length)){
HXLINE(  64)						 ::flixel::FlxSprite sprite = _g5->__get(_g4).StaticCast<  ::flixel::FlxSprite >();
HXDLIN(  64)						_g4 = (_g4 + 1);
...
HX_DEFINE_DYNAMIC_FUNC2(FlxUITabMenu_obj,getTab,return )
 ...
 ::flixel::addons::ui::FlxTypedUIGroup FlxUITabMenu_obj::getTabGroup(::String name, ::Dynamic index){
...
HXLINE( 259)				 ::flixel::addons::ui::FlxTypedUIGroup tabGroup = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxTypedUIGroup >();
HXDLIN( 259)				_g = (_g + 1);
...
HXLINE( 271)				return this->_tab_groups->__get(( (int)(index) )).StaticCast<  ::flixel::addons::ui::FlxTypedUIGroup >();
            			}
            		}
...
HXLINE( 360)				::Dynamic t1 = _g3->__get(_g2);
HXDLIN( 360)				_g2 = (_g2 + 1);
HXLINE( 362)				tab = ( ( ::flixel::addons::ui::FlxUITypedButton)(t1) );
...
HXLINE( 370)				 ::flixel::addons::ui::FlxTypedUIGroup group = _g5->__get(_g4).StaticCast<  ::flixel::addons::ui::FlxTypedUIGroup >();
...
HXDLIN( 449)			 ::flixel::addons::ui::FlxTypedUIGroup group = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxTypedUIGroup >();
HXDLIN( 449)			_g = (_g + 1);
...
HXLINE( 556)			 ::flixel::FlxSprite _hx_tmp2 = this->_back;
HXDLIN( 556)			Float _hx_tmp3 = ( (Float)(this->_tabs->__get(0)->__Field(HX_("y",79,00,00,00),::hx::paccDynamic)) );
HXDLIN( 556)			_hx_tmp2->set_y(((_hx_tmp3 + ::flixel::addons::ui::interfaces::IFlxUIWidget_obj::get_height(this->_tabs->__get(0))) - ( (Float)(2) )));
