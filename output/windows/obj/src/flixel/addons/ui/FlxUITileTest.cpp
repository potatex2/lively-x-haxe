...
HXLINE(  70)				{
HXLINE(  70)					int _g2 = 0;
HXDLIN(  70)					int _g3 = tilesTall;
HXDLIN(  70)					while((_g2 < _g3)){
HXLINE(  70)						_g2 = (_g2 + 1);
HXDLIN(  70)						int iy = (_g2 - 1);
...
HX_DEFINE_DYNAMIC_FUNC6(FlxUITileTest_obj,makeTiles,(void))
 ...
 ::flixel::math::FlxBasePoint FlxUITileTest_obj::constrain(Float w,Float h){
            	HX_STACKFRAME(&_hx_pos_1ed93265c305abdf_90_constrain)
...
HXLINE( 119)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(tileWidth,tileHeight);
