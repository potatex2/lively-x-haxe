...
HXLINE(  65)			 ::flixel::addons::ui::FlxUIText _hx_tmp1 = this->_titleText;
HXDLIN(  65)			_hx_tmp1->set_width(( (Float)(::Std_obj::_hx_int(this->_titleText->textField->set_width(( (Float)(this->style->__Field(HX_("titleWidth",4e,c9,47,dc),::hx::paccDynamic)) )))) ));
            		}
HXLINE(  67)		if (::hx::IsGreater( this->style->__Field(HX_("bodyWidth",04,e0,6a,8a),::hx::paccDynamic),0 )) {
HXLINE(  69)			 ::flixel::addons::ui::FlxUIText _hx_tmp2 = this->_bodyText;
HXDLIN(  69)			_hx_tmp2->set_width(( (Float)(::Std_obj::_hx_int(this->_bodyText->textField->set_width(( (Float)(this->style->__Field(HX_("bodyWidth",04,e0,6a,8a),::hx::paccDynamic)) )))) ));
            		}
...
HXLINE( 100)			 ::flixel::addons::ui::FlxUIText _hx_tmp3 = this->_titleText;
HXDLIN( 100)			_hx_tmp3->set_x(( (Float)(::Std_obj::_hx_int(( ( ::flixel::math::FlxBasePoint)(this->style->__Field(HX_("titleOffset",4b,63,cb,f6),::hx::paccDynamic)) )->x)) ));
HXLINE( 101)			 ::flixel::addons::ui::FlxUIText _hx_tmp4 = this->_titleText;
HXDLIN( 101)			_hx_tmp4->set_y(( (Float)(::Std_obj::_hx_int(( ( ::flixel::math::FlxBasePoint)(this->style->__Field(HX_("titleOffset",4b,63,cb,f6),::hx::paccDynamic)) )->y)) ));
            		}
HXLINE( 103)		if (::hx::IsNotNull( this->style->__Field(HX_("bodyOffset",d5,2b,5c,a7),::hx::paccDynamic) )) {
HXLINE( 105)			 ::flixel::addons::ui::FlxUIText _hx_tmp5 = this->_bodyText;
HXDLIN( 105)			_hx_tmp5->set_x(( (Float)(::Std_obj::_hx_int(( ( ::flixel::math::FlxBasePoint)(this->style->__Field(HX_("bodyOffset",d5,2b,5c,a7),::hx::paccDynamic)) )->x)) ));
HXLINE( 106)			 ::flixel::addons::ui::FlxUIText _hx_tmp6 = this->_bodyText;
HXDLIN( 106)			_hx_tmp6->set_y(( (Float)(::Std_obj::_hx_int(((this->_titleText->y + titleHeight) + ( ( ::flixel::math::FlxBasePoint)(this->style->__Field(HX_("bodyOffset",d5,2b,5c,a7),::hx::paccDynamic)) )->y))) ));
            		}
...
HXLINE( 162)			 ::flixel::FlxSprite fh2 = this->_bkg;
HXDLIN( 162)			fh2->set_x((fh2->x + xx));
HXLINE( 163)			 ::flixel::addons::ui::FlxUIText fh3 = this->_titleText;
HXDLIN( 163)			fh3->set_x((fh3->x + xx));
HXLINE( 164)			 ::flixel::addons::ui::FlxUIText fh4 = this->_bodyText;
HXDLIN( 164)			fh4->set_x((fh4->x + xx));
...
HXLINE( 170)			 ::flixel::FlxSprite fh5 = this->_bkg;
HXDLIN( 170)			fh5->set_y((fh5->y + yy));
HXLINE( 171)			 ::flixel::addons::ui::FlxUIText fh6 = this->_titleText;
HXDLIN( 171)			fh6->set_y((fh6->y + yy));
HXLINE( 172)			 ::flixel::addons::ui::FlxUIText fh7 = this->_bodyText;
HXDLIN( 172)			fh7->set_y((fh7->y + yy));
HXLINE( 173)			this->_arrow->set_y(( (Float)(0) ));
            		}
HXLINE( 176)		bool _hx_tmp7;
HXDLIN( 176)		if ((this->_titleText->text != HX_("",00,00,00,00))) {
HXLINE( 176)			_hx_tmp7 = (this->_bodyText->text == HX_("",00,00,00,00));
            		}
            		else {
...
HXLINE( 183)			 ::flixel::addons::ui::FlxUIText fh8 = this->_titleText;
HXDLIN( 183)			fh8->set_y((fh8->y + titleOnlyOffset));
            		}
HXLINE( 187)		 ::flixel::addons::ui::FlxUIText fh9 = this->_titleText;
HXDLIN( 187)		fh9->set_x(( (Float)((fh9->x + this->style->__Field(HX_("leftPadding",8a,98,10,d0),::hx::paccDynamic))) ));
HXLINE( 188)		 ::flixel::addons::ui::FlxUIText fh10 = this->_bodyText;
HXDLIN( 188)		fh10->set_x(( (Float)((fh10->x + this->style->__Field(HX_("leftPadding",8a,98,10,d0),::hx::paccDynamic))) ));
HXLINE( 190)		 ::flixel::addons::ui::FlxUIText fh11 = this->_titleText;
HXDLIN( 190)		fh11->set_y(( (Float)((fh11->y + this->style->__Field(HX_("topPadding",bc,47,4b,3c),::hx::paccDynamic))) ));
HXLINE( 191)		 ::flixel::addons::ui::FlxUIText fh12 = this->_bodyText;
HXDLIN( 191)		fh12->set_y(( (Float)((fh12->y + this->style->__Field(HX_("topPadding",bc,47,4b,3c),::hx::paccDynamic))) ));
...
HXLINE( 199)			 ::flixel::addons::ui::FlxUIText _hx_tmp8 = this->_titleText;
HXDLIN( 199)			_hx_tmp8->set_width(this->_bkg->get_width());
            		}
...
HXLINE( 206)			 ::flixel::addons::ui::FlxUIText _hx_tmp9 = this->_bodyText;
HXDLIN( 206)			_hx_tmp9->set_width(this->_bkg->get_width());
            		}
...
HXLINE( 214)		 ::flixel::FlxSprite _hx_tmp10 = this->_arrowBkg;
HXDLIN( 214)		_hx_tmp10->set_x(( (Float)(::Std_obj::_hx_int((this->_arrow->x - ( (Float)(this->style->__Field(HX_("borderSize",cd,ff,ed,06),::hx::paccDynamic)) )))) ));
HXLINE( 215)		 ::flixel::FlxSprite _hx_tmp11 = this->_arrowBkg;
HXDLIN( 215)		_hx_tmp11->set_y(( (Float)(::Std_obj::_hx_int((this->_arrow->y - ( (Float)(this->style->__Field(HX_("borderSize",cd,ff,ed,06),::hx::paccDynamic)) )))) ));
HXLINE( 217)		 ::flixel::addons::ui::FlxUIText _hx_tmp12 = this->_titleText;
HXDLIN( 217)		_hx_tmp12->set_x(( (Float)(::Std_obj::_hx_int(this->_titleText->x)) ));
HXLINE( 218)		 ::flixel::addons::ui::FlxUIText _hx_tmp13 = this->_bodyText;
HXDLIN( 218)		_hx_tmp13->set_x(( (Float)(::Std_obj::_hx_int(this->_bodyText->x)) ));
HXLINE( 219)		 ::flixel::FlxSprite _hx_tmp14 = this->_bkg;
HXDLIN( 219)		_hx_tmp14->set_x(( (Float)(::Std_obj::_hx_int(this->_bkg->x)) ));
HXLINE( 220)		 ::flixel::FlxSprite _hx_tmp15 = this->_bkg;
HXDLIN( 220)		_hx_tmp15->set_y(( (Float)(::Std_obj::_hx_int(this->_bkg->y)) ));
HXLINE( 221)		 ::flixel::FlxSprite _hx_tmp16 = this->_arrowBkg;
HXDLIN( 221)		_hx_tmp16->set_x(( (Float)(::Std_obj::_hx_int(this->_arrowBkg->x)) ));
HXLINE( 222)		 ::flixel::FlxSprite _hx_tmp17 = this->_arrowBkg;
HXDLIN( 222)		_hx_tmp17->set_y(( (Float)(::Std_obj::_hx_int(this->_arrowBkg->y)) ));
HXLINE( 223)		 ::flixel::FlxSprite _hx_tmp18 = this->_arrow;
HXDLIN( 223)		_hx_tmp18->set_x(( (Float)(::Std_obj::_hx_int(this->_arrow->x)) ));
HXLINE( 224)		 ::flixel::FlxSprite _hx_tmp19 = this->_arrow;
HXDLIN( 224)		_hx_tmp19->set_y(( (Float)(::Std_obj::_hx_int(this->_arrow->y)) ));
            	}
...
HXLINE( 238)		{
HXLINE( 238)			int _g = 0;
HXDLIN( 238)			::Array< ::Dynamic> _g1 = this->group->members;
...
HXLINE( 500)					 ::flixel::addons::ui::AnchorPoint fh1 = result->x;
HXDLIN( 500)					fh1->offset = (fh1->offset + off);
...
HXLINE( 509)					 ::flixel::addons::ui::AnchorPoint fh2 = result->y;
HXDLIN( 509)					fh2->offset = (fh2->offset - ( (Float)(off) ));
...
HXLINE( 514)					 ::flixel::addons::ui::AnchorPoint fh3 = result->y;
HXDLIN( 514)					fh3->offset = (fh3->offset + off);
...
HXLINE( 526)					 ::flixel::addons::ui::AnchorPoint fh4 = result->x;
HXDLIN( 526)					fh4->offset = (fh4->offset + off);
            				}
HXLINE( 528)				if ((result->x->flush == HX_("right",dc,0b,64,e9))) {
HXLINE( 530)					 ::flixel::addons::ui::AnchorPoint fh5 = result->x;
HXDLIN( 530)					fh5->offset = (fh5->offset - ( (Float)(off) ));
            				}
            			}
HXLINE( 533)			if (matchVert) {
HXLINE( 535)				if ((result->y->flush == HX_("top",95,66,58,00))) {
HXLINE( 537)					 ::flixel::addons::ui::AnchorPoint fh6 = result->y;
HXDLIN( 537)					fh6->offset = (fh6->offset + off);
            				}
HXLINE( 539)				if ((result->y->flush == HX_("bottom",eb,e6,78,65))) {
HXLINE( 541)					 ::flixel::addons::ui::AnchorPoint fh7 = result->y;
HXDLIN( 541)					fh7->offset = (fh7->offset - ( (Float)(off) ));
            				}
            			}
            		}
...
HXLINE( 667)				bool _hx_tmp7;
HXDLIN( 667)				if (::hx::IsNotNull( ( ( ::flixel::addons::ui::FontDef)(Style->__Field(HX_("titleFormat",ef,5a,1a,94),::hx::paccDynamic)) )->format )) {
HXLINE( 667)					_hx_tmp7 = ::hx::IsNotNull( ( ( ::flixel::addons::ui::FontDef)(DefaultStyle->__Field(HX_("titleFormat",ef,5a,1a,94),::hx::paccDynamic)) )->format );
            				}
            				else {
HXLINE( 667)					_hx_tmp7 = false;
            				}
HXDLIN( 667)				if (_hx_tmp7) {
...
HXLINE( 675)					_hx_tmp8 = ::hx::IsNotNull( ( ( ::flixel::addons::ui::FontDef)(DefaultStyle->__Field(HX_("bodyFormat",79,23,ab,44),::hx::paccDynamic)) )->format );
            				}
            				else {
HXLINE( 675)					_hx_tmp8 = false;
            				}
...
HXLINE( 702)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(0,0);
HXDLIN( 702)			point->_inPool = false;
HXDLIN( 702)			Style->__SetField(HX_("titleOffset",4b,63,cb,f6),point,::hx::paccDynamic);
            		}
HXLINE( 704)		if (::hx::IsNull( Style->__Field(HX_("bodyOffset",d5,2b,5c,a7),::hx::paccDynamic) )) {
HXLINE( 706)			 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(0,0);
HXDLIN( 706)			point1->_inPool = false;
HXDLIN( 706)			Style->__SetField(HX_("bodyOffset",d5,2b,5c,a7),point1,::hx::paccDynamic);
            		}
...
HXLINE( 721)		bool _hx_tmp9;
HXDLIN( 721)		if (::hx::IsNotNull( Style->__Field(HX_("borderSize",cd,ff,ed,06),::hx::paccDynamic) )) {
HXLINE( 721)			_hx_tmp9 = ::hx::IsLess( Style->__Field(HX_("borderSize",cd,ff,ed,06),::hx::paccDynamic),0 );
            		}
            		else {
HXLINE( 721)			_hx_tmp9 = true;
            		}
HXDLIN( 721)		if (_hx_tmp9) {
HXLINE( 723)			Style->__SetField(HX_("borderSize",cd,ff,ed,06),1,::hx::paccDynamic);
            		}
HXLINE( 725)		bool _hx_tmp10;
HXDLIN( 725)		if (::hx::IsNotNull( Style->__Field(HX_("titleWidth",4e,c9,47,dc),::hx::paccDynamic) )) {
HXLINE( 725)			_hx_tmp10 = ::hx::IsLess( Style->__Field(HX_("titleWidth",4e,c9,47,dc),::hx::paccDynamic),0 );
            		}
            		else {
HXLINE( 725)			_hx_tmp10 = true;
            		}
HXDLIN( 725)		if (_hx_tmp10) {
...
HXLINE( 729)			_hx_tmp11 = ::hx::IsLess( Style->__Field(HX_("bodyWidth",04,e0,6a,8a),::hx::paccDynamic),0 );
            		}
            		else {
HXLINE( 729)			_hx_tmp11 = true;
            		}
...
HXLINE( 742)		bool _hx_tmp12;
HXDLIN( 742)		if (::hx::IsNotNull( Style->__Field(HX_("leftPadding",8a,98,10,d0),::hx::paccDynamic) )) {
HXLINE( 742)			_hx_tmp12 = ::hx::IsLess( Style->__Field(HX_("leftPadding",8a,98,10,d0),::hx::paccDynamic),0 );
            		}
            		else {
...
HXLINE( 746)		bool _hx_tmp13;
HXDLIN( 746)		if (::hx::IsNotNull( Style->__Field(HX_("rightPadding",55,e9,2b,bb),::hx::paccDynamic) )) {
HXLINE( 746)			_hx_tmp13 = ::hx::IsLess( Style->__Field(HX_("rightPadding",55,e9,2b,bb),::hx::paccDynamic),0 );
            		}
            		else {
HXLINE( 746)			_hx_tmp13 = true;
            		}
HXDLIN( 746)		if (_hx_tmp13) {
HXLINE( 748)			Style->__SetField(HX_("rightPadding",55,e9,2b,bb),0,::hx::paccDynamic);
            		}
HXLINE( 750)		bool _hx_tmp14;
HXDLIN( 750)		if (::hx::IsNotNull( Style->__Field(HX_("topPadding",bc,47,4b,3c),::hx::paccDynamic) )) {
HXLINE( 750)			_hx_tmp14 = ::hx::IsLess( Style->__Field(HX_("topPadding",bc,47,4b,3c),::hx::paccDynamic),0 );
            		}
            		else {
...
HXLINE( 754)		bool _hx_tmp15;
HXDLIN( 754)		if (::hx::IsNotNull( Style->__Field(HX_("leftPadding",8a,98,10,d0),::hx::paccDynamic) )) {
HXLINE( 754)			_hx_tmp15 = ::hx::IsLess( Style->__Field(HX_("bottomPadding",26,1e,2d,2b),::hx::paccDynamic),0 );
            		}
            		else {
HXLINE( 754)			_hx_tmp15 = true;
            		}
HXDLIN( 754)		if (_hx_tmp15) {
...
HXLINE( 776)		 ::flixel::math::FlxBasePoint this1 = ( ( ::flixel::math::FlxBasePoint)(s->__Field(HX_("titleOffset",4b,63,cb,f6),::hx::paccDynamic)) );
HXDLIN( 776)		 ::flixel::math::FlxBasePoint p = null();
HXDLIN( 776)		if (::hx::IsNull( p )) {
HXLINE( 776)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 776)			point->_inPool = false;
HXDLIN( 776)			p = point;
            		}
HXDLIN( 776)		Float y = this1->y;
HXDLIN( 776)		p->set_x(this1->x);
HXDLIN( 776)		p->set_y(y);
HXLINE( 777)		 ::flixel::math::FlxBasePoint this2 = ( ( ::flixel::math::FlxBasePoint)(s->__Field(HX_("bodyOffset",d5,2b,5c,a7),::hx::paccDynamic)) );
HXDLIN( 777)		 ::flixel::math::FlxBasePoint p1 = null();
HXDLIN( 777)		if (::hx::IsNull( p1 )) {
HXLINE( 777)			 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 777)			point1->_inPool = false;
HXDLIN( 777)			p1 = point1;
            		}
HXDLIN( 777)		Float y1 = this2->y;
HXDLIN( 777)		p1->set_x(this2->x);
HXDLIN( 777)		p1->set_y(y1);
HXLINE( 778)		 ::flixel::addons::ui::BorderDef obj = ( ( ::flixel::addons::ui::BorderDef)(s->__Field(HX_("titleBorder",a4,18,a6,fa),::hx::paccDynamic)) )->clone();
HXLINE( 779)		 ::flixel::addons::ui::BorderDef obj1 = ( ( ::flixel::addons::ui::BorderDef)(s->__Field(HX_("bodyBorder",2e,e1,36,ab),::hx::paccDynamic)) )->clone();
HXLINE( 767)		 ::Dynamic obj2 =  ::Dynamic(::hx::Anon_obj::Create(18)
...
HXLINE( 801)			 ::flixel::addons::ui::BorderDef _hx_tmp3;
HXDLIN( 801)			if (::hx::IsNotNull( b->border )) {
HXLINE( 801)				_hx_tmp3 = b->border->clone();
            			}
            			else {
HXLINE( 801)				_hx_tmp3 = null();
            			}
HXDLIN( 801)			a->border = _hx_tmp3;
            		}
            	}
