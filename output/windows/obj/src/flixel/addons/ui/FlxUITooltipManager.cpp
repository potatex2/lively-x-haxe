...
HXLINE(  63)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(0,0);
HXDLIN(  63)		point->_inPool = false;
HXDLIN(  63)		this->lastPosition = point;
...
HXLINE( 141)		if (::Std_obj::isOfType(thing,::hx::ClassOf< ::flixel::addons::ui::FlxTypedUIGroup >())) {
HXLINE( 143)			int i = this->findObj(( ( ::flixel::FlxObject)(thing) ));
HXLINE( 144)			if ((i != -1)) {
HXLINE( 145)				return (i == this->current);
            			}
HXLINE( 147)			if (checkChildren) {
HXLINE( 149)				 ::flixel::addons::ui::FlxTypedUIGroup fuig = ( ( ::flixel::addons::ui::FlxTypedUIGroup)(thing) );
HXLINE( 150)				{
HXLINE( 150)					int _g = 0;
...
HXLINE( 161)				int i1 = this->findBtn(thing);
HXLINE( 162)				if ((i1 == -1)) {
HXLINE( 163)					return false;
            				}
HXLINE( 164)				return (i1 == this->current);
            			}
            			else {
HXLINE( 166)				if (::Std_obj::isOfType(thing,::hx::ClassOf< ::flixel::FlxObject >())) {
HXLINE( 168)					int i2 = this->findObj(( ( ::flixel::FlxObject)(thing) ));
HXLINE( 169)					if ((i2 == -1)) {
HXLINE( 170)						return false;
            					}
HXLINE( 171)					return (i2 == this->current);
            				}
            			}
            		}
...
HXLINE( 279)				Float _hx_tmp1 = thing->get_width();
HXDLIN( 279)				b->resize(_hx_tmp1,thing->get_height());
HXLINE( 281)				btn = b;
...
HXLINE( 302)				::Array< ::Dynamic> _hx_tmp2 = this->list;
HXDLIN( 302)				_hx_tmp2->push( ::flixel::addons::ui::_FlxUITooltipManager::FlxUITooltipEntry_obj::__alloc( HX_CTX ,btn,data,thing));
            			}
            			else {
...
HXLINE( 313)				::Dynamic _hx_tmp3 = this->list->__get(i).StaticCast<  ::flixel::addons::ui::_FlxUITooltipManager::FlxUITooltipEntry >()->btn;
HXDLIN( 313)				::flixel::addons::ui::interfaces::IFlxUIWidget_obj::set_width(_hx_tmp3,thing->get_width());
HXLINE( 314)				::Dynamic _hx_tmp4 = this->list->__get(i).StaticCast<  ::flixel::addons::ui::_FlxUITooltipManager::FlxUITooltipEntry >()->btn;
HXDLIN( 314)				::flixel::addons::ui::interfaces::IFlxUIWidget_obj::set_height(_hx_tmp4,thing->get_height());
HXLINE( 315)				{
HXLINE( 315)					 ::flixel::math::FlxBasePoint this2 = ( ( ::flixel::math::FlxBasePoint)(this->list->__get(i).StaticCast<  ::flixel::addons::ui::_FlxUITooltipManager::FlxUITooltipEntry >()->btn->__Field(HX_("scrollFactor",bc,ec,cf,3b),::hx::paccDynamic)) );
HXDLIN( 315)					Float y1 = thing->scrollFactor->y;
HXDLIN( 315)					this2->set_x(thing->scrollFactor->x);
HXDLIN( 315)					this2->set_y(y1);
            				}
            			}
            		}
            	}
...
HXLINE( 381)					_hx_tmp2 = ::flixel::addons::ui::interfaces::IFlxUIButton_obj::get_mouseIsOver(btn);
            				}
            				else {
HXLINE( 381)					_hx_tmp2 = true;
            				}
...
HXLINE( 389)					_hx_tmp3 = ::hx::IsGreater( this->list->__get(i).StaticCast<  ::flixel::addons::ui::_FlxUITooltipManager::FlxUITooltipEntry >()->count,this->list->__get(i).StaticCast<  ::flixel::addons::ui::_FlxUITooltipManager::FlxUITooltipEntry >()->data->__Field(HX_("delay",83,d7,26,d7),::hx::paccDynamic) );
            				}
            				else {
...
HXLINE( 496)			 ::flixel::FlxSprite _hx_tmp1 = this->tooltip->_arrow;
HXDLIN( 496)			_hx_tmp1->set_visible(this->tooltip->_arrowBkg->set_visible(b));
            		}
...
HXLINE( 571)			 ::flixel::addons::ui::Anchor _hx_tmp2;
HXDLIN( 571)			if (::hx::IsNotNull( this->fixedPosition )) {
HXLINE( 571)				_hx_tmp2 = ( ( ::flixel::addons::ui::Anchor)(this->fixedPosition->__Field(HX_("anchor",75,3a,71,60),::hx::paccDynamic)) );
            			}
            			else {
HXLINE( 571)				_hx_tmp2 = null();
            			}
HXDLIN( 571)			if (this->checkAutoFlip(this->tooltip,_hx_tmp2)) {
...
HXLINE( 599)			Float tooltip2 = tooltip->y;
HXDLIN( 599)			Float flipY1 = (tooltip2 + tooltip->get_height());
