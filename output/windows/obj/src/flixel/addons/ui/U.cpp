...
HXLINE(  96)				HX_STACK_DO_THROW((HX_("U.parseHex() unable to parse hex String ",07,7d,1f,93) + str));
            			}
...
HXLINE( 159)						HX_STACK_DO_THROW((HX_("U.parseHex() unable to parse hex String ",07,7d,1f,93) + str));
            					}
...
HXLINE( 179)					_hx_tmp1 = ::hx::IsEq( match->__Field(HX_("len",d5,4b,52,00),::hx::paccDynamic),str.length );
            				}
            				else {
...
HXLINE( 198)				_hx_tmp1 = ::hx::IsEq( p->__Field(HX_("len",d5,4b,52,00),::hx::paccDynamic),str.length );
            			}
            			else {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(U_obj,boolify,return )
 ...
 ::flixel::math::FlxBasePoint U_obj::pointify(::String str){
            	HX_STACKFRAME(&_hx_pos_9939526bb4013f05_300_pointify)
HXLINE( 301)		 ::flixel::math::FlxBasePoint pt = null();
...
HXLINE( 322)				Float x = ::Std_obj::parseFloat(arr->__get(0));
HXDLIN( 322)				Float y = ::Std_obj::parseFloat(arr->__get(1));
HXDLIN( 322)				 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y);
...
HXLINE( 410)					_hx_tmp1 = (op == HX_("!=",fc,1c,00,00));
            				}
            				else {
...
HXLINE( 379)				_hx_tmp2 = (op == HX_("=",3d,00,00,00));
            			}
            			else {
...
HXLINE( 383)					_hx_tmp3 = (op == HX_("!=",fc,1c,00,00));
            				}
            				else {
HXLINE( 383)					_hx_tmp3 = true;
            				}
...
HXLINE( 352)				_hx_tmp4 = (op == HX_("=",3d,00,00,00));
            			}
            			else {
...
HXLINE( 356)				bool _hx_tmp5;
HXDLIN( 356)				if ((op != HX_("!==",c1,3f,19,00))) {
HXLINE( 356)					_hx_tmp5 = (op == HX_("!=",fc,1c,00,00));
            				}
            				else {
HXLINE( 356)					_hx_tmp5 = true;
            				}
...
HXLINE( 341)			bool _hx_tmp6;
HXDLIN( 341)			if ((op != HX_("==",60,35,00,00))) {
HXLINE( 341)				_hx_tmp6 = (op == HX_("=",3d,00,00,00));
            			}
            			else {
HXLINE( 341)				_hx_tmp6 = true;
            			}
HXDLIN( 341)			if (_hx_tmp6) {
HXLINE( 343)				return (variable == otherValue);
            			}
HXLINE( 345)			bool _hx_tmp7;
HXDLIN( 345)			if ((op != HX_("!==",c1,3f,19,00))) {
HXLINE( 345)				_hx_tmp7 = (op == HX_("!=",fc,1c,00,00));
            			}
            			else {
...
HXLINE( 459)							HX_STACK_DO_THROW(((HX_("couldn't load bmp \"",73,a2,6e,30) + att) + HX_("\"",22,00,00,00)));
            						}
            					} catch( ::Dynamic _hx_e) {
            						if (_hx_e.IsClass< ::String >() && _hx_e->toString()!=null() ){
            							HX_STACK_BEGIN_CATCH
            							::String msg1 = _hx_e;
HXLINE( 464)							 ::flixel::_hx_system::frontEnds::LogFrontEnd _this1 = ::flixel::FlxG_obj::log;
HXDLIN( 464)							_this1->advanced((HX_("FlxUI: U.xml_gfx() : ",f9,3c,00,4f) + msg1),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            						}
...
HXLINE( 455)							if (::Std_obj::isOfType(_g->value,::hx::ClassOf< ::String >())) {
...
HXLINE( 487)			Float fb12 = fb1->y;
HXDLIN( 487)			Float _hx_tmp1 = fb1->get_height();
HXDLIN( 487)			fb2->set_y((fb12 + ((_hx_tmp1 - fb2->get_height()) / ( (Float)(2) ))));
            		}
            	}
...
HXLINE( 582)			if (!(safe)) {
HXLINE( 584)				HX_STACK_DO_THROW((HX_("U.parseHex() unable to parse hex String ",07,7d,1f,93) + str));
            			}
            			else {
...
HXDLIN( 609)			goto _hx_goto_36;
            		...
            		/* default */{
HXLINE( 610)			HX_STACK_DO_THROW(((HX_("U.hexChar2dec() illegal char(",11,98,18,de) + hex_char) + HX_(")",29,00,00,00)));
            		}
            		_hx_goto_36:;
HXLINE( 601)		return 0;
            	}
...
HXDLIN( 628)				goto _hx_goto_39;
            			...
            			/* default */{
HXLINE( 628)				HX_STACK_DO_THROW(((HX_("U.hexChar2dec() illegal char(",11,98,18,de) + char_hex) + HX_(")",29,00,00,00)));
            			}
            			_hx_goto_39:;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(U_obj,hex2rgb,return )
 ...
 ::flixel::math::FlxBasePoint U_obj::applyResize(Float resize_ratio,int resize_ratio_axis,Float w,Float h, ::flixel::math::FlxBasePoint pt){
            	HX_STACKFRAME(&_hx_pos_9939526bb4013f05_649_applyResize)
HXLINE( 650)		if (::hx::IsNull( pt )) {
HXLINE( 652)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE( 679)		{
HXLINE( 679)			pt->set_x(w);
HXDLIN( 679)			pt->set_y(h);
            		}
...
HXLINE( 749)				{
HXLINE( 749)					int _g2 = xmin;
HXDLIN( 749)					int _g3 = (xmax + 1);
HXDLIN( 749)					while((_g2 < _g3)){
HXLINE( 749)						_g2 = (_g2 + 1);
HXDLIN( 749)						int xx = (_g2 - 1);
HXLINE( 751)						 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(xx,yy);
...
HXDLIN( 774)			HX_STACK_DO_THROW((HX_("Invalid nodeType ",3b,e0,cb,e1) + ::_Xml::XmlType_Impl__obj::toString(x->nodeType)));
            		}
HXDLIN( 774)		return x;
            	}
...
HXLINE( 798)				HX_STACK_DO_THROW((HX_("Invalid nodeType ",3b,e0,cb,e1) + ::_Xml::XmlType_Impl__obj::toString(xml->nodeType)));
            			}
HXDLIN( 798)			return xml;
            		}
...
HXLINE( 934)				_hx_tmp1 = (x->nodeType != ::Xml_obj::Element);
            			}
            			else {
HXLINE( 934)				_hx_tmp1 = false;
            			}
HXDLIN( 934)			if (_hx_tmp1) {
HXLINE( 934)				HX_STACK_DO_THROW((HX_("Invalid nodeType ",3b,e0,cb,e1) + ::_Xml::XmlType_Impl__obj::toString(x->nodeType)));
            			}
HXDLIN( 934)			 ::Xml fast = x;
...
HXLINE(1400)					{
HXLINE(1400)						int _g2 = 0;
HXDLIN(1400)						int _g3 = widthInTiles;
HXDLIN(1400)						while((_g2 < _g3)){
HXLINE(1400)							_g2 = (_g2 + 1);
HXDLIN(1400)							int tilex = (_g2 - 1);
...
HXLINE(1550)				HX_STACK_DO_THROW(((HX_("Error! Scale must be positive & > 0! (Scale was = ",a9,42,eb,3c) + Scale) + HX_(")",29,00,00,00)));
            			}
...
HXLINE(1574)						 ::openfl::geom::Rectangle scaledBmp2 = scaledBmp1->rect;
HXDLIN(1574)						black->copyPixels(scaledBmp1,scaledBmp2, ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null()),null(),null(),true);
HXLINE(1576)						 ::openfl::geom::Rectangle scaledBmp3 = scaledBmp1->rect;
HXDLIN(1576)						black->copyChannel(scaledBmp1,scaledBmp3, ::openfl::geom::Point_obj::__alloc( HX_CTX ,0,0),8,8);
...
HXLINE(1668)				{
HXLINE(1668)					int _g2 = 0;
HXDLIN(1668)					int _g3 = w;
HXDLIN(1668)					while((_g2 < _g3)){
HXLINE(1668)						_g2 = (_g2 + 1);
HXDLIN(1668)						int c = (_g2 - 1);
...
HXLINE(1706)				{
HXLINE(1706)					int _g2 = 0;
HXDLIN(1706)					int _g3 = w;
HXDLIN(1706)					while((_g2 < _g3)){
HXLINE(1706)						_g2 = (_g2 + 1);
HXDLIN(1706)						int c = (_g2 - 1);
...
HXDLIN(1820)						if ((lo >= 0)) {
HXLINE(1820)							_hx_tmp1 = (hi > lo);
            						}
            						else {
HXLINE(1820)							_hx_tmp1 = false;
            						}
HXDLIN(1820)						if (_hx_tmp1) {
HXLINE(1822)							int _g1 = lo;
HXDLIN(1822)							int _g2 = hi;
HXDLIN(1822)							while((_g1 < _g2)){
HXLINE(1822)								_g1 = (_g1 + 1);
HXDLIN(1822)								int i = (_g1 - 1);
...
HXLINE(1857)						bool _hx_tmp1;
HXDLIN(1857)						if ((lo >= 0)) {
HXLINE(1857)							_hx_tmp1 = (hi > lo);
            						}
            						else {
HXLINE(1857)							_hx_tmp1 = false;
            						}
HXDLIN(1857)						if (_hx_tmp1) {
HXLINE(1859)							int _g1 = lo;
HXDLIN(1859)							int _g2 = hi;
HXDLIN(1859)							while((_g1 < _g2)){
HXLINE(1859)								_g1 = (_g1 + 1);
HXDLIN(1859)								int i = (_g1 - 1);
...
HXDLIN(1930)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y);
HXDLIN(1930)		point->_inPool = false;
HXDLIN(1930)		 ::flixel::math::FlxBasePoint ipt = point;
...
HXLINE(2009)			bool _hx_tmp1;
HXDLIN(2009)			if (::hx::IsNotNull( arr->__get(0) )) {
HXLINE(2009)				_hx_tmp1 = (arr->__get(0).length > 1);
            			}
            			else {
HXLINE(2009)				_hx_tmp1 = false;
            			}
...
HXLINE(2208)					bool _hx_tmp1;
HXDLIN(2208)					bool _hx_tmp2;
HXDLIN(2208)					if ((str.charAt((str.length - 1)) == HX_(">",3e,00,00,00))) {
HXLINE(2208)						_hx_tmp2 = (str.charAt((str.length - 2)) != HX_("/",2f,00,00,00));
            					}
            					else {
HXLINE(2208)						_hx_tmp2 = false;
            					}
HXDLIN(2208)					if (_hx_tmp2) {
HXLINE(2208)						_hx_tmp1 = (str.charAt((str.length - 2)) != HX_("-",2d,00,00,00));
            					}
            					else {
