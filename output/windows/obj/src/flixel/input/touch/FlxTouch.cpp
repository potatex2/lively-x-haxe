...
HXDLIN(  90)				 ::flixel::math::FlxBasePoint this2 = this->justPressedPosition;
...
HXDLIN(  90)				Float y1 = this2->y;
HXDLIN(  90)				p->set_x(this2->x);
HXDLIN(  90)				p->set_y(y1);
HXDLIN(  90)				 ::flixel::math::FlxBasePoint _hx_tmp2 = this->getScreenPosition(null(),null());
HXDLIN(  90)				_hx_tmp->push( ::flixel::input::FlxSwipe_obj::__alloc( HX_CTX ,_hx_tmp1,p,_hx_tmp2,this->justPressedTimeInTicks));
            			}
            		}
            	}
