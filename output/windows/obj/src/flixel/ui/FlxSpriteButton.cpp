...
HXLINE(  29)				 ::flixel::math::FlxBasePoint point = _g1->__get(_g).StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN(  29)				_g = (_g + 1);
HXLINE(  30)				{
HXLINE(  30)					Float y = (point->y + 4);
HXDLIN(  30)					point->set_x((point->x - ( (Float)(1) )));
HXDLIN(  30)					point->set_y(y);
            				}
            			}
            		}
