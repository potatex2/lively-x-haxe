...
HXDLIN( 245)					_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 245)					_this->copyFromArray(array,null());
HXDLIN( 245)					this1 = _this;
            				}
            				else {
HXLINE( 245)					if (::hx::IsNotNull( vector )) {
HXLINE( 245)						 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 245)						::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 245)						_this1->byteOffset = 0;
HXDLIN( 245)						_this1->length = array1->get_length();
HXDLIN( 245)						_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 245)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 245)						_this1->copyFromArray(array1,null());
HXDLIN( 245)						this1 = _this1;
            					}
            					else {
HXLINE( 245)						if (::hx::IsNotNull( view )) {
HXLINE( 245)							 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 245)							int elementSize = _this2->bytesPerElement;
HXDLIN( 245)							if ((view->type == _this2->type)) {
HXLINE( 245)								int srcLength1 = srcData->length;
HXDLIN( 245)								int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 245)								_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 245)								_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            							}
            							else {
HXLINE( 245)								HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            							}
HXDLIN( 245)							_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 245)							_this2->byteOffset = 0;
HXDLIN( 245)							_this2->length = srcLength;
HXDLIN( 245)							this1 = _this2;
            						}
            						else {
HXLINE( 245)							if (::hx::IsNotNull( data )) {
HXLINE( 245)								 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 245)								int in_byteOffset = 0;
HXDLIN( 245)								if ((in_byteOffset < 0)) {
HXLINE( 245)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 245)								if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 245)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 245)								int bufferByteLength = data->length;
HXDLIN( 245)								int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 245)									if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 245)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
...
HXLINE( 245)									newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 245)									int newRange = (in_byteOffset + newByteLength);
HXDLIN( 245)									if ((newRange > bufferByteLength)) {
HXLINE( 245)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
HXDLIN( 245)								_this3->buffer = data;
HXDLIN( 245)								_this3->byteOffset = in_byteOffset;
HXDLIN( 245)								_this3->byteLength = newByteLength;
HXDLIN( 245)								_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 245)								this1 = _this3;
            							}
            							else {
HXLINE( 245)								HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            							}
            						}
            					}
            				}
...
HXDLIN( 366)				int _g2 = count;
HXDLIN( 366)				while((_g1 < _g2)){
HXLINE( 366)					_g1 = (_g1 + 1);
HXDLIN( 366)					int i1 = (_g1 - 1);
...
HXDLIN( 386)						int _g4 = height;
HXDLIN( 386)						while((_g3 < _g4)){
HXLINE( 386)							_g3 = (_g3 + 1);
HXDLIN( 386)							int i2 = (_g3 - 1);
HXLINE( 388)							dataPosition = (((i2 + offsetY) * bufferWidth) + offsetX);
...
HXDLIN( 410)					_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 410)					_this->copyFromArray(array,null());
HXDLIN( 410)					this1 = _this;
            				}
            				else {
HXLINE( 410)					if (::hx::IsNotNull( vector )) {
HXLINE( 410)						 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 410)						::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 410)						_this1->byteOffset = 0;
HXDLIN( 410)						_this1->length = array1->get_length();
HXDLIN( 410)						_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 410)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 410)						_this1->copyFromArray(array1,null());
HXDLIN( 410)						this1 = _this1;
            					}
            					else {
HXLINE( 410)						if (::hx::IsNotNull( view )) {
HXLINE( 410)							 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 410)							int elementSize = _this2->bytesPerElement;
HXDLIN( 410)							if ((view->type == _this2->type)) {
HXLINE( 410)								int srcLength1 = srcData->length;
HXDLIN( 410)								int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 410)								_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 410)								_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            							}
            							else {
HXLINE( 410)								HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            							}
HXDLIN( 410)							_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 410)							_this2->byteOffset = 0;
HXDLIN( 410)							_this2->length = srcLength;
HXDLIN( 410)							this1 = _this2;
            						}
            						else {
HXLINE( 410)							if (::hx::IsNotNull( data )) {
HXLINE( 410)								 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 410)								int in_byteOffset = 0;
HXDLIN( 410)								if ((in_byteOffset < 0)) {
HXLINE( 410)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 410)								if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 410)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN( 410)								int bufferByteLength = data->length;
HXDLIN( 410)								int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 410)									if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 410)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
...
HXLINE( 410)									newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 410)									int newRange = (in_byteOffset + newByteLength);
HXDLIN( 410)									if ((newRange > bufferByteLength)) {
HXLINE( 410)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
HXDLIN( 410)								_this3->buffer = data;
HXDLIN( 410)								_this3->byteOffset = in_byteOffset;
HXDLIN( 410)								_this3->byteLength = newByteLength;
HXDLIN( 410)								_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 410)								this1 = _this3;
            							}
            							else {
HXLINE( 410)								HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            							}
            						}
            					}
            				}
