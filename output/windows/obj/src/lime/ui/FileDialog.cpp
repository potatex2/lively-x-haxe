...
HXLINE( 179)					path1 = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_save_file(title,filter,defaultPath);
HXLINE( 183)					worker->sendComplete(( ( ::Dynamic)(path1) ));
            				}
            				break;
            				case (int)3: {
HXLINE( 153)					 ::hx::Object * path2 = ::hx::DynamicPtr(null());
HXLINE( 159)					path2 = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_open_directory(title,filter,defaultPath);
...
HXLINE( 197)							_hx_tmp2 = ::hx::IsNotNull( filter );
            						}
            						else {
HXLINE( 197)							_hx_tmp2 = false;
            						}
HXDLIN( 197)						if (_hx_tmp2) {
HXLINE( 197)							_hx_tmp1 = (path.indexOf(HX_(".",2e,00,00,00),null()) == -1);
            						}
            						else {
